...
def main(args):
    ...
    num_data_files = len(os.listdir(args.npz_dir))

    # load the label files
    labels = []
    for i in range(num_data_files):
        npz_file = np.load('{0}/batch_{1}.npz'.format(args.npz_dir, i+1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('npz_dir', help='path to npz files containing the labels')
